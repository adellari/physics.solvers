...
- (nullable NSData *)copyPackedVertexPositions;

- (nullable NSData *)copyPackedVertexNormals;

- (nullable NSData *)copyPackedVertexUVs;
...
GLTFKIT2_EXPORT
@interface GLTFPrimitive (VertexNormalsAccess)
- (nullable NSData *)copyPackedVertexNormals;
@end

GLTFKIT2_EXPORT
@interface GLTFPrimitive (VertexUVsAccess)
- (nullable NSData *)copyPackedVertexUVs;
@end
